...
def audit_transverse():
    ...
    try:
        df_2023 = pd.read_excel('data/raw/ponte_2023.xlsx')
        df_2024 = pd.read_excel('data/raw/ponte_2024.xlsx')
        df_2025 = pd.read_excel('data/raw/ponte_2025.xlsx')
    ...
    df_comparaison.to_csv('data/audit/audit_comparaison_colonnes.csv', index=False, encoding='utf-8-sig', sep=';')
    print("✓ audit_comparaison_colonnes.csv généré")

    # 3. Statistiques détaillées
    print("\n[3/6] Analyse statistique par année...")
    analyser_colonnes(df_2023).to_csv('data/audit/audit_stats_2023.csv', index=False, encoding='utf-8-sig', sep=';')
    analyser_colonnes(df_2024).to_csv('data/audit/audit_stats_2024.csv', index=False, encoding='utf-8-sig', sep=';')
    analyser_colonnes(df_2025).to_csv('data/audit/audit_stats_2025.csv', index=False, encoding='utf-8-sig', sep=';')
    ...
    pd.DataFrame(presence_poules).to_csv('data/audit/audit_presence_poules_groupes.csv', index=False, encoding='utf-8-sig', sep=';')
    ...
    creer_tableau_notations_poules(notations_dict).to_csv('data/audit/audit_notations_poules.csv', encoding='utf-8-sig', sep=';')
    ...
    all_results.to_csv('data/audit/audit_notations_hors_poules.csv', index=False, encoding='utf-8-sig', sep=';')
