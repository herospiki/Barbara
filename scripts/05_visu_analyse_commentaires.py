...
def generate_step5_visualization():
    ...
    try:
        df = pd.read_csv('data/intermediaire/tableau_commentaires.csv', sep=';')
    except FileNotFoundError:
        print("Erreur : Fichier data/intermediaire/tableau_commentaires.csv non trouvé.")
        return
    ...
    with open('output/step5_visualisation_analyse_commentaires.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    print("Visualisation générée : output/step5_visualisation_analyse_commentaires.html")
