...
def generate_visualization():
    ...
    df1 = pd.read_csv('interim/df_1_meteo.csv', sep=';')
    ...
    with open('interim/step3_visualisation_nettoyage_meteo.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    print("Visualisation générée : interim/step3_visualisation_nettoyage_meteo.html")
