...
def charger_donnees():
    ...
    fichiers = {
        'presence': 'audit/audit_presence_poules_groupes.csv',
        'comparaison': 'audit/audit_comparaison_colonnes.csv',
        'notations': 'audit/audit_notations_poules.csv',
        'stats_2023': 'audit/audit_stats_2023.csv',
        'stats_2024': 'audit/audit_stats_2024.csv',
        'stats_2025': 'audit/audit_stats_2025.csv'
    }
...
def generate_report():
    ...
    df_hors_poules = pd.read_csv('audit/audit_notations_hors_poules.csv', sep=';')
